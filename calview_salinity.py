...
old_new_sel = pn.widgets.RadioButtonGroup(
    #name='',
    value="New salinity outputs",
    button_style='outline',
    button_type='primary',
    options=["New salinity outputs", "Previously generated visuals"],
    max_width=1000
)
...
old_new_sel.value = "New salinity outputs"
...
o_floatpanel = pn.layout.FloatPanel(pn.Column(file_instructions, file_structure, file_instructions_2), name='New DSM2 File Selection Instructions', margin=20, theme='primary')
